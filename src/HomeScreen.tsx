...
import { TourGuideZone, useTourGuideController } from '../srcs'
const HomeScreen = () => {
    ...
    React.useEffect(() => {
        ...
        return () => eventEmitter && eventEmitter.off('*', null)
    }, [])
    return (
        <View style={styles.container}>
            ...
            <Text>Hello npx expo install npx expo install expo-image-picker</Text>
        </View>
    )
}
